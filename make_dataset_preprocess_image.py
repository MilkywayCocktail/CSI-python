...
def mask(image, background, show=True):
    image_masked = image - background
    m = image_masked < 10
    image_masked = image_masked * m
...
if __name__ == '__main__':
    make_masked('../sense/1213/121303.bag', '../sense/1213/','../sense/1213/env.jpg', length=1800)
    # make_background('../sense/1213/1213env.bag', '../sense/1213/env.jpg', 300)